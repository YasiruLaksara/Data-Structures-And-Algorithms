...
struct HashTable{
	...
	//add an if condition to complete the code here
        if (empty){
            ...
            cout << "User Successfully Entered The Password."<<endl;
        }
        else{
            cout<<"Collision Was Detected !"<<endl;
        }
	...
	//add an if condition to complete the code here
        if (! empty){
            cout<<"User:- "<< user_name << "Password:- "<< password[hash]<<endl;
        }
        else{
